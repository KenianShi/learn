...
func main() {
	...
	//第四个参数为备份文件大小
	//第五个参数为文件大小的单位
	logger.SetRollingFile(`./`, "test.log", 10, 1, logger.KB)
	...
	//重新指定log文件
	lg.SetRollingFile(`C:./`, "test.log", 10, 1, logger.KB)
	lg.SetLevelFile(logger.INFO, `./`, "info.log")
	lg.SetLevelFile(logger.WARN, `./`, "warn.log")
